...
mod test {
    ...
    fn compare_expiration() {
        ...
        assert!(
            Expiration::AtTime(555)
                < Expiration::AtTime(777)
        );
        assert!(
            Expiration::AtTime(86)
                < Expiration::AtTime(100)
        );
        ...
        assert!(!(Expiration::AtTime(1000) == Expiration::AtHeight(230)));
    }
